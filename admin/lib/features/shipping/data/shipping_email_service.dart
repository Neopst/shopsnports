...
/// Handles shipping request confirmations, status updates, and tracking assignments
class ShippingEmailService {
  ...
  /// Send email via Cloud Function (HTTP endpoint)
  Future<void> _sendEmail({
    ...
    try {
      // Call Cloud Function endpoint for sending email
      final callableUrl =
          'https://us-central1-shopsnports.cloudfunctions.net/sendEmail';
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>&copy; 2025 Shop's & Ports. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
