// FILE: lib/features/shipping/domain/enhanced_shipping_request_model.dart
...
class EnhancedShippingRequest {
  ...
  factory EnhancedShippingRequest.fromFirestore(DocumentSnapshot doc) {
    final data = doc.data() as Map<String, dynamic>;
    return EnhancedShippingRequest(
      id: doc.id,
